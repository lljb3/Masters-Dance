    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function _enqueue_new() {
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/codemirror.min.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/colors-control.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/customizer-control.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/fonts-customizer-admin.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/header-control.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/header-models.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/jquery.slimscroll.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/jquery.ui.droppable.min.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/media-editor.min.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/new-customizer.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/previewing.js" />';
                //echo '<script type="text/javascript" src="' . $this->_extension_url . '"new/theme-customizer.js" />';
